...

  {
    ...
    children: [
      ...
      // forms
      {
        ...
        component: RouteView,
        meta: { title: '表单页', icon: 'form', roles: [ 'admin' ] },
        children: [
          {
            path: '/form/base-form',
            name: 'BaseForm',
        ...
        children: [
          {
            ...
            meta: { title: '查询表格', keepAlive: true, roles: [ 'admin' ] }
          },
          {
            path: '/list/basic-list',
            name: 'BasicList',
            component: () => import('@/views/list/BasicList'),
            meta: { title: '标准列表', keepAlive: true, roles: [ 'admin' ] }
          },
          {
            path: '/list/card',
            name: 'CardList',
            component: () => import('@/views/list/CardList'),
            meta: { title: '卡片列表', keepAlive: true, roles: [ 'admin' ] }
          },
          {
            path: '/list/search',
            name: 'SearchList',
            ...
            meta: { title: '搜索列表', keepAlive: true, roles: [ 'admin' ] },
            children: [
              {
      ...
      // profile
      {
        ...
        meta: { title: '详情页', icon: 'profile', roles: [ 'admin' ] },
        children: [
          {
            path: '/profile/basic',
            name: 'ProfileBasic',
