...
<h1 align="center">基于 Ant Design Vue Pro 进行二次开发</h1>
	1.权限路由改为后端与前端控制；（配置项修改)
	2.侧边栏配置本地化；
	3.mock or EGG接口；
	4.感谢Ant Design Vue Pro
	5.本项目完全免费
	6.默认master为egg提供接口，EGG仓库地址:https://gitee.com/yeyoudubai/EggDemo
	7.mock版为mocker分支
...
![dashboard](https://s1.ax1x.com/2020/08/07/aW7IlF.png)
